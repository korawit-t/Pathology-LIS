 ...
 * - "pending immuno" — ยังรอผล IHC อยู่ (ยังอ่านไม่ได้) แต่ดันขึ้นมาให้เห็นเพราะเป็นงาน
 *   ที่ต้องตามต่อ ไม่ใช่งานที่ปิดไปแล้ว
 *
 * หมายเหตุ: "pending special stains" จงใจไม่รวม — ถ้าจะเปลี่ยนใจให้เพิ่มที่นี่ที่เดียว
 *
