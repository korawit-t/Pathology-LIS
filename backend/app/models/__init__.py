...
from .nongyne_specimen_disposal_batch import (
...
# Explicit re-export list: tells ruff/pyflakes these imports are load-bearing
# (SQLAlchemy metadata registration for Alembic autogenerate), not dead code.
__all__ = [
    "User",
    "Patient",
    "SurgicalSpecimen",
    ...
    "LegacyGyneCytoReport",
    "LegacyNongyneCytoReport",
    "LlmProfile",
    "TumorRegistry",
    "WsiScannerProfile",
    "WsiSetting",
